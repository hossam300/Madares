<%@ Page Title="" Language="C#" MasterPageFile="~/StudentAfair/SFMasterPage.master" AutoEventWireup="true" CodeBehind="Students.aspx.cs" Inherits="ERPWebForms.StudentAfair.Students" Culture="auto" meta:resourcekey="PageResource2" UICulture="auto" %>
                    ...
                    <div>
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" Width="100%" EnableTheming="True" Theme="Moderno" KeyFieldName="ID" PreviewFieldName="ID" DataMember="ID" EnableCallBacks="False" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" OnStartRowEditing="ASPxGridView1_StartRowEditing" meta:resourcekey="ASPxGridView1Resource1">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Gender" FieldName="Gender" Name="Gender" VisibleIndex="5" meta:resourcekey="GridViewDataTextColumnResource12">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Religion" FieldName="Religion" Name="Religion" VisibleIndex="6" meta:resourcekey="GridViewDataTextColumnResource13">
                                </dx:GridViewDataTextColumn>
                            </Columns>
