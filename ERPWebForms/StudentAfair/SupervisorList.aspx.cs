...
{
    public partial class SupervisorList : BasePage
    {
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnview")
            {
                ...
                Response.Redirect("~/StudentAfair/ViewSupervisor.aspx?id=" + id);
            }
        }
        ...
        protected void ASPxGridView1_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            ...
            Response.Redirect("~/StudentAfair/AddSupervisor.aspx?id=" + id);
        }
        ...
        protected void btnNewSupervisor_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/StudentAfair/AddSupervisor.aspx?id=0");
        }
    }
}