<%@ Page Title="" Language="C#" MasterPageFile="~/StudentAfair/SFMasterPage.master" AutoEventWireup="true" CodeBehind="AddTeacher.aspx.cs" Inherits="ERPWebForms.StudentAfair.AddTeacher" %>
                        ...
                        <div id="form103" class="form_container left_label valid_tip">
                                        ...
                                        <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                                <div class="form_grid_4 alpha">
                                                    <asp:TextBox ID="txtTeacherName" placeholder="Teacher Name" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtTeacherNameResource1"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ControlToValidate="txtTeacherName" ErrorMessage="*" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>
                                                </div>
                                                <label class="field_title">&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label4" runat="server" Text="Email" meta:resourcekey="Label4Resource1"></asp:Label></label>
                                                <div class="form_grid_4">
                                                    <asp:TextBox ID="txtEmail" placeholder="Email" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtEmailResource1"></asp:TextBox>
                                                </div>
                                        ...
                                        <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                                <div class="form_grid_8 alpha">
                                                    <asp:CheckBoxList ID="cblCourses" runat="server" meta:resourcekey="cblCoursesResource1">
                                                    </asp:CheckBoxList>
                                                    <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red" ControlToValidate="cblCourses" ErrorMessage="*" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>--%>
                                                </div>
                                                <span class="clear"></span>
                                            </div>
                                        </div>
                            ...
                            <ul>
                                <li>
                                    <div class="form_grid_12">
                                        <div class="form_input">
                                            <asp:Button ID="btnEdit" runat="server" Text="Edit" class="btn_small btn_blue" OnClick="btnEdit_Click" Visible="false" meta:resourcekey="btnEditResource1" OnClientClick="if (!Page_ClientValidate()){ return false; } this.disabled = true; this.value = 'Saving...';" UseSubmitBehavior="false" />
