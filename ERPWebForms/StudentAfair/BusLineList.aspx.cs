...
{
    public partial class BusLineList :BasePage
    {
        ...
        private void AddSubmitEvent()
        {
            ...
            trigger.ControlID = btnExportBusListx.UniqueID;
            UpdatePanelControlTrigger trigger2 = new PostBackTrigger();
            trigger2.ControlID = btnExportBusListw.UniqueID;
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnview")
            {
                ...
                Response.Redirect("~/StudentAfair/ViewBusLine.aspx?id=" + id);
            }
        }
        ...
        protected void ASPxGridView1_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            ...
            Response.Redirect("~/StudentAfair/AddBusLine.aspx?id=" + id);
        }

        protected void btnNewDriver_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/StudentAfair/AddBusLine.aspx?id=0");
        }
