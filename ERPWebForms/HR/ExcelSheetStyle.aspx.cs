...
{
    public partial class ExcelSheetStyle : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.ExcelSheetStyle, Request.Cookies["user"]["Permission"].ToString()))
                    Response.Redirect("~/HR/UnAuthorized.aspx");
            }
            //Bonus bonus = new Bonus();
            //DataTable dt = bonus.getListDeduction();
        ...
        {
            Response.Redirect("~/HR/CreatesheetStyle.aspx?id=0");
        }
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnview")
            {
                ...
                int id = Convert.ToInt32(dr["SheetStyleID"].ToString());
                Response.Redirect("~/HR/ViewsheetStyle.aspx?id=" + id);
