...
namespace ERPWebForms.HR
{
    public partial class Reviews : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.Reviews, Request.Cookies["user"]["Permission"].ToString()))
        ...
        {
            Response.Redirect("~/HR/CreateReview.aspx?id=0");
        }
