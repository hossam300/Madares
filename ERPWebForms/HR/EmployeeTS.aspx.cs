...
{
    public partial class EmployeeTS : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.EmployeeTS, Request.Cookies["user"]["Permission"].ToString()))
                    Response.Redirect("~/HR/UnAuthorized.aspx");
            }
            /*  Reviews reviews = new Reviews();

              DataTable dt = reviews.getList();
        ...
        {
            Response.Redirect("~/HR/CreateTimeSheet.aspx?id=0");
        }
        ...
        protected void ASPxGridView1_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            ...
            Response.Redirect("~/HR/CreateTimeSheet.aspx?id=" + id);
        }
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnview")
            {
                ...
                int id = Convert.ToInt32(dr["TimeSheetID"].ToString());
