...
{
    public partial class Deductions : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.Deductions, Request.Cookies["user"]["Permission"].ToString()))
        ...
        {
            Response.Redirect("~/HR/CreateDeduction.aspx?id=0");
        }
