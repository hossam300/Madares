...
namespace ERPWebForms.HR
{
    public partial class Holidays : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.Holidays, Request.Cookies["user"]["Permission"].ToString()))
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnview")
            {
                ...
                int id = Convert.ToInt32(dr["HolidayID"].ToString());
                Response.Redirect("~/HR/ViewHoliday.aspx?id=" + id);
        ...
        {
            Response.Redirect("~/HR/AddHoliday.aspx?id=0");
        }
