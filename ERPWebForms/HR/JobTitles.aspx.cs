...
{
    public partial class JobTitles : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.JobTitles, Request.Cookies["user"]["Permission"].ToString()))
                    Response.Redirect("~/HR/UnAuthorized.aspx");
            }
            Jobtitle jobtitle = new Jobtitle();
            DataTable dt = jobtitle.getList();
        ...
        {
            Response.Redirect("~/HR/CreateJobtitle.aspx?id=0");
        }
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnview")
            {
                ...
                int id = Convert.ToInt32(dr["JobTitleID"].ToString());
                Response.Redirect("~/HR/ViewJobtitle.aspx?id=" + id);
