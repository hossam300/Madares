...
{
    public partial class ViewBonus : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.ViewBonus, Request.Cookies["user"]["Permission"].ToString()))
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/HR/CreateBonus.aspx?id=" + id);
        }
