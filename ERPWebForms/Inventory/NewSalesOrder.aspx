<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="NewSalesOrder.aspx.cs" Inherits="ERPWebForms.Inventory.NewSalesOrder" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                                    ...
                                    <div class="form_grid_12">
                                        <fieldset style="border: 1px solid">
                                            ...
                                            <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" Width="100%" EnableTheming="True" Theme="Moderno" AutoGenerateColumns="False" DataMember="ID" KeyFieldName="ID" PreviewFieldName="ID" OnRowDeleting="grid_RowDeleting"
                                                ...
                                                <Columns>
                                                    <dx:GridViewCommandColumn ShowNewButtonInHeader="True" VisibleIndex="0" meta:resourcekey="GridViewCommandColumnResource1" Caption="New">
                                                    </dx:GridViewCommandColumn>
                                                    <dx:GridViewCommandColumn ShowDeleteButton="True" ShowEditButton="True" VisibleIndex="7" meta:resourcekey="GridViewCommandColumnResource2" Caption="Edit / Delete">
                                                    </dx:GridViewCommandColumn>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_4 alpha">
                                                <asp:DropDownList ID="ddlCustomer" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="ID" meta:resourcekey="ddlCustomerResource1">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ForeColor="Red" ControlToValidate="ddlCustomer" ErrorMessage="*" meta:resourcekey="RequiredFieldValidator7Resource1"></asp:RequiredFieldValidator>
                                            </div>
                                            <label class="field_title">
                                                &nbsp;&nbsp;
