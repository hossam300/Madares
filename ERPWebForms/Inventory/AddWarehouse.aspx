<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="AddWarehouse.aspx.cs" Inherits="ERPWebForms.Inventory.AddWarehouse" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            ...
                                            <div class="form_grid_4">
                                                <asp:DropDownList ID="ddlStoreKeeper" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource1" DataTextField="name" DataValueField="user_id" meta:resourcekey="ddlStoreKeeperResource1">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" ControlToValidate="ddlStoreKeeper" ErrorMessage="*" meta:resourcekey="RequiredFieldValidator2Resource1"></asp:RequiredFieldValidator>
                                            </div>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_10 alpha">
                                                <asp:TextBox TextMode="MultiLine" ID="txtWarehouseAddress" placeholder="Warehouse Address" Columns="5" Rows="5" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtWarehouseAddressResource1"></asp:TextBox>
                                            </div>
                                            <span class="clear"></span>
                                        </div>
                                    </div>
