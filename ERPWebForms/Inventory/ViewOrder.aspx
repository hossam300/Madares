<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="ViewOrder.aspx.cs" Inherits="ERPWebForms.Inventory.ViewOrder" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                            ...
                            <ul>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            ...
                                            <div class="form_grid_4 alpha">
                                                <asp:DropDownList ID="ddlSupplier" Enabled="False" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="ID" meta:resourcekey="ddlSupplierResource1">
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_4 alpha">
                                                <asp:DropDownList ID="ddlStatus" Enabled="False" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" meta:resourcekey="ddlStatusResource1">
                                            ...
                                            <div class="form_grid_4">
                                                <asp:Label ID="txtRejectionReason" placeholder="Rejection Reason" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtRejectionReasonResource1"></asp:Label>
                                            </div>
                                            <span class="clear"></span>
                                        </div>
                                    </div>
