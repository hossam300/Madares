...
{
    public partial class DeletedCustomers : BasePage
    {
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnView")
            {
                ...
                Response.Redirect("~/Inventory/ViewCustomer.aspx?id=" + id);
            }
        ...
        {
            Response.Redirect("~/Inventory/AddCustomer.aspx?id=0");
        }
