...
{
    public partial class DeletedDispatchItems : BasePage
    {
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnView")
            {
                ...
                Response.Redirect("~/Inventory/ViewDispatchItem.aspx?id=" + id);
            }
        ...
        protected void btnDispatchItem_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Inventory/DispatchItem.aspx?id=0");
        }
    }
}