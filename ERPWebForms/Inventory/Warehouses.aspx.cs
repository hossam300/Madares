    ...
    public partial class Warehouses : BasePage
    {
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnView")
            {
                ...
                Response.Redirect("~/Inventory/ViewWarehouse.aspx?id=" + id);
            }
        ...
        protected void ASPxGridView1_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            ...
            Response.Redirect("~/Inventory/AddWarehouse.aspx?id=" + id);
        }

        protected void btnProductCategory_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Inventory/AddWarehouse.aspx?id=0");
        }
