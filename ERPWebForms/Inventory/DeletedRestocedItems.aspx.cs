...
{
    public partial class DeletedRestocedItems : BasePage
    {
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnView")
            {
                ...
                Response.Redirect("~/Inventory/ViewRestockedItem.aspx?id=" + id);
            }
        ...
        protected void btnAddItemstoStock_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Inventory/AddNewItemToStock.aspx?id=0");
        }
