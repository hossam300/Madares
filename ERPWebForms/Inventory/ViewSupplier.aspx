<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="ViewSupplier.aspx.cs" Inherits="ERPWebForms.Inventory.ViewSupplier" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            ...
                                            <div class="form_grid_4">
                                                <asp:TextBox ID="txtRemarks" placeholder="Remarks" Enabled="False" TextMode="MultiLine" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtRemarksResource1"></asp:TextBox>
                                            </div>
                                            <span class="clear"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_10 alpha">
                                                <asp:TextBox TextMode="MultiLine" Enabled="False" ID="txtAddress" placeholder="Address" Columns="5" Rows="5" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtAddressResource1"></asp:TextBox>
                                            </div>
                                            <span class="clear"></span>
                                        </div>
                                    </div>
