<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="ViewDispatchItem.aspx.cs" Inherits="ERPWebForms.Inventory.ViewDispatchItem" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                            ...
                            <ul>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            ...
                                            <div class="form_grid_4">
                                                <asp:DropDownList ID="ddlStuff" Enabled="False" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource2" DataTextField="name" DataValueField="user_id" meta:resourcekey="ddlStuffResource1">
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_4 alpha">
                                                <asp:DropDownList ID="ddlWarehouse" Enabled="False" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource3" DataTextField="Name" DataValueField="ID" meta:resourcekey="ddlWarehouseResource1">
