...
{
    public partial class SalesOrders : BasePage
    {
        ...
        {
            Response.Redirect("~/Inventory/NewSalesOrder.aspx?id=0");
        }
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnView")
            {
                ...
                Response.Redirect("~/Inventory/ViewSalesOrder.aspx?id=" + id);
            }
