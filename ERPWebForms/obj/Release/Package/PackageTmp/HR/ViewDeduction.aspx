<%@ Page Title="" Language="C#" MasterPageFile="~/HR/HRMasterPage.master" AutoEventWireup="true" CodeBehind="ViewDeduction.aspx.cs" Inherits="ERPWebForms.HR.ViewDeduction" %>
                                    ...
                                    <li>
                                        <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                                ...
                                                <label class="field_title">
                                                    <label class="field_title">
                                                        <asp:Label ID="lblType" runat="server" Text="<%$ Resources:Type %>"></asp:Label></label></label>
