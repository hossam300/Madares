<%@ Page Title="" Language="C#" MasterPageFile="~/HR/HRMasterPage.master" AutoEventWireup="true" CodeBehind="CreateJobCategory.aspx.cs" Inherits="ERPWebForms.HR.CreateJobCategory" %>
            ...
            <div class="grid_12">
                <div class="widget_wrap">
                    <div class="widget_top">
                        ...
                        <h6>
                            <asp:Label ID="Label2" runat="server" Text="Create Job Category" meta:resourcekey="Label2Resource1"></asp:Label></h6>
                    </div>
                                        ...
                                        <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                                <div class="form_grid_4 alpha">
                                                    <asp:TextBox ID="txtJobCategory" placeholder="Job Category" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtJobCategoryResource1"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ForeColor="Red" ControlToValidate="txtJobCategory" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                </div>
