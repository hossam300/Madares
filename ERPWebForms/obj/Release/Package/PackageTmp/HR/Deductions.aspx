<%@ Page Title="" Language="C#" MasterPageFile="~/HR/HRMasterPage.master" AutoEventWireup="true" CodeBehind="Deductions.aspx.cs" Inherits="ERPWebForms.HR.Deductions" %>
            ...
            <div class="grid_12 full_block">
                <div class="widget_wrap">
                    <div class="widget_top">
                        ...
                        <h6>
                            <asp:Label ID="Label2" runat="server" Text="Deduction" meta:resourcekey="Label2Resource1"></asp:Label></h6>
                    </div>
                    <div>
