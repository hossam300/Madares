                            ...
                            <fieldset style="border: 1px solid">
                                ...
                                <ul>
                                        ...
                                        <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                                <div class="form_grid_4 alpha">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="number" runat="server" ForeColor="Red" ControlToValidate="txtEmpCode" ValidationExpression="^\d+$" ErrorMessage="Number Only" />
                                                </div>
                                                <label class="field_title">
                                                    &nbsp;&nbsp;
                                                ...
                                                <div class="form_grid_4">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ForeColor="Red" ControlToValidate="txtSallary" ValidationExpression="^\d+$" ErrorMessage="Number Only" />
                                                </div>
                                                <span class="clear"></span>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                                ...
                                                <label class="field_title">&nbsp;&nbsp;<asp:Label ID="Label22" runat="server" Text="Religion" meta:resourcekey="ReligionResource1"></asp:Label></label>
                                                <div class="form_grid_4">
                                                     <asp:DropDownList ID="ddlReligion" runat="server" DataSourceID="SqlDataSource7" DataTextField="Name" DataValueField="ID" Style="width: 100%" class="chzn-select" TabIndex="13" meta:resourcekey="ddlReligionResource1"></asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ForeColor="Red" ControlToValidate="ddlReligion" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                    <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:ERP2ConnectionString %>" SelectCommand="SELECT [ID], [Name] FROM HR_LUTReligions"></asp:SqlDataSource>
                                                </div>
                                    ...
                                    <li>
                                        <div class="form_grid_12">
                                            <label class="field_title">
                                                <asp:Label ID="Label16" runat="server" Text="ID Number" meta:resourcekey="IDNumberResource1"></asp:Label></label>
                                            <div class="form_input">
                                                <div class="form_grid_4 alpha">
                                                    <asp:TextBox ID="txtIDNumber" placeholder="ID Number" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtIDNumberResource1"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ForeColor="Red" ControlToValidate="txtIDNumber" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ForeColor="Red" ControlToValidate="txtIDNumber" ValidationExpression="^\d+$" ErrorMessage="Number Only" />
                                                </div>
                                                <label class="field_title">&nbsp;&nbsp;<asp:Label ID="Label17" runat="server" Text="Telephone Number" meta:resourcekey="TelephoneNoResource1"></asp:Label></label>
                                                <div class="form_grid_4">
                                                     <asp:TextBox ID="txtTelephoneNo" placeholder="Telephone Number" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtTeleNumberResource1"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ForeColor="Red" ControlToValidate="txtTelephoneNo" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red" ControlToValidate="txtTelephoneNo" ValidationExpression="^\d+$" ErrorMessage="Number Only" />
                                                </div>
                                                <span class="clear"></span>
                                            </div>
                                        </div>
                                     ...
                                     <li>
                                        <div class="form_grid_12">
                                            <label class="field_title">
                                                <asp:Label ID="Label20" runat="server" Text="Graduation Year" meta:resourcekey="GraduationYearResource1"></asp:Label></label>
                                            <div class="form_input">
                                                <div class="form_grid_4 alpha">
                                                    <asp:TextBox ID="txtGraduationYear" placeholder="Graduation Year" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtGraduationYearResource1"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ForeColor="Red" ControlToValidate="txtGraduationYear" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ForeColor="Red" ControlToValidate="txtGraduationYear" ValidationExpression="^\d+$" ErrorMessage="Number Only" />
                                                    
                                                </div>
                                                <label class="field_title">&nbsp;&nbsp;<asp:Label ID="Label21" runat="server" Text="Resign Date" meta:resourcekey="ResignDateResource1"></asp:Label></label>
                                                <div class="form_grid_4">
                                                     <asp:TextBox ID="txtResignDate" placeholder="Resign Date" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtTeleNumberResource1"></asp:TextBox>
                                                    
                                                    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtResignDate" BehaviorID="CalendarExtender1" Format="dd/MM/yyyy" />
                                                </div>
                                                <span class="clear"></span>
                                            </div>
                                        </div>
                                     ...
                                     <li>
                                        <div class="form_grid_12">
                                            <label class="field_title">
                                                <asp:Label ID="Label18" runat="server" Text="Marital Status" meta:resourcekey="MaritalStatusResource1"></asp:Label></label>
                                            <div class="form_input">
                                                <div class="form_grid_4 alpha">
                                                    <asp:DropDownList ID="ddlMaritalStatus" runat="server" DataSourceID="SqlDataSource5" DataTextField="Name" DataValueField="ID" Style="width: 100%" class="chzn-select" TabIndex="13" meta:resourcekey="ddlMaritalStatusResource1"></asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ForeColor="Red" ControlToValidate="ddlMaritalStatus" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                     <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ERP2ConnectionString %>" SelectCommand="SELECT [ID], [Name] FROM HR_LUTMaritalStatus"></asp:SqlDataSource>
                                                </div>
                                                <label class="field_title">&nbsp;&nbsp;<asp:Label ID="Label19" runat="server" Text="Qualification" meta:resourcekey="QualificationResource1"></asp:Label></label>
                                                <div class="form_grid_4">
                                                     <asp:DropDownList ID="ddlQualification" runat="server" DataSourceID="SqlDataSource6" DataTextField="Name" DataValueField="ID" Style="width: 100%" class="chzn-select" TabIndex="13" meta:resourcekey="ddlQualificationResource1"></asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ForeColor="Red" ControlToValidate="ddlQualification" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:ERP2ConnectionString %>" SelectCommand="SELECT [ID], [Name] FROM HR_LUTQualifications"></asp:SqlDataSource>
                                                </div>
                                                <span class="clear"></span>
                                            </div>
                                        </div>
                                     ...
                                     <li>
                                        <div class="form_grid_12">
                                            <label class="field_title">
                                                <asp:Label ID="Label23" runat="server" Text="Address" meta:resourcekey="AddressResource1"></asp:Label></label>
                                            <div class="form_input">
                                                <div class="form_grid_10 alpha">
                                                    <asp:TextBox ID="txtAddress" TextMode="MultiLine" placeholder="Address" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtAddressResource1"></asp:TextBox>
                                    ...
                                    <li>
                                        <div class="form_grid_12">
                                            <label class="field_title">
                                                <asp:Label ID="Label24" runat="server" Text="Experience" meta:resourcekey="ExperienceResource1"></asp:Label></label>
                                            <div class="form_input">
                                                <div class="form_grid_10 alpha">
                                                    <asp:TextBox ID="txtExperience" TextMode="MultiLine" placeholder="Experience" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtExperienceResource1"></asp:TextBox>
