<%@ Page Title="" Language="C#" MasterPageFile="~/HR/HRMasterPage.master" AutoEventWireup="true" CodeBehind="ViewJobCategory.aspx.cs" Inherits="ERPWebForms.HR.ViewJobCategory" %>
            ...
            <div class="grid_12">
                <div class="widget_wrap">
                    <div class="widget_top">
                        ...
                        <h6>
                            <asp:Label ID="Label2" runat="server" Text="View Job Category" meta:resourcekey="Label2Resource1"></asp:Label></h6>
                    </div>
                    <div class="widget_content">
                        <div id="form103" class="form_container left_label valid_tip">
                                    ...
                                    <li>
                                        <div class="form_grid_12">
                                            <label class="field_title">
                                                <asp:Label ID="Label3" runat="server" Text="Job Category" meta:resourcekey="Label3Resource1"></asp:Label></label>
                                            <div class="form_input">
                                                <div class="form_grid_4 alpha">
                                                    <asp:Label ID="txtJobCategory" placeholder="Job Category" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtJobCategoryResource1"></asp:Label>
                                                </div>
                            ...
                            <fieldset>
                                <legend>
                                    <asp:Label ID="Label4" runat="server" Text="Employees" meta:resourcekey="Label4Resource1"></asp:Label></legend>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ERP2ConnectionString %>" SelectCommand="SELECT [EmpID], [EmpName], [Sallary], [Specialty], [ReportTo], [Nationality], [HiringDate], [EmpCode] FROM [HR_Employees] WHERE ([JobCategoryID] = @JobCategoryID)">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="JobCategoryID" QueryStringField="id" Type="Int32" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </fieldset>
                        </div>
