<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="ViewRestockedItem.aspx.cs" Inherits="ERPWebForms.Inventory.ViewRestockedItem" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                            ...
                            <ul>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_4 alpha">
                                                <asp:DropDownList ID="ddlProduct" Enabled="False" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="ID" meta:resourcekey="ddlProductResource1">
                                            ...
                                            <div class="form_grid_4">
                                                <asp:DropDownList ID="ddlSupplier" Enabled="False" runat="server" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="ID" meta:resourcekey="ddlSupplierResource1">
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_4 alpha">
                                                <asp:DropDownList ID="ddlWarehouse" runat="server" Enabled="False" class="chzn-select" AppendDataBoundItems="True" TabIndex="13" Width="100%" DataSourceID="SqlDataSource3" DataTextField="Name" DataValueField="ID" meta:resourcekey="ddlWarehouseResource1">
                                            ...
                                            <div class="form_grid_4">
                                                <asp:Label ID="txtQuantity" placeholder="Quantity" TextMode="Number" Width="100%" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtQuantityResource1"></asp:Label>
                                            </div>
                                            <span class="clear"></span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_4 alpha">
                                                <asp:Label ID="txtTotalCost" placeholder="Total Cost" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtTotalCostResource1"></asp:Label>
                                            </div>
                                            <label class="field_title">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Label ID="Label6" runat="server" Text="Unit Cost" meta:resourcekey="Label6Resource1"></asp:Label></label>
                                            <div class="form_grid_4">
                                                <asp:Label ID="txtUnitCost" placeholder="Unit Cost" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtUnitCostResource1"></asp:Label>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_4 alpha">
                                                <a href="#" runat="server" id="hrefURL" name="hrefURL" ></a>
                                            </div>
                                            <label class="field_title">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
