<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="DeletedRestocedItems.aspx.cs" Inherits="ERPWebForms.Inventory.DeletedRestocedItems" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <div class="grid_12 full_block">
                <div class="widget_wrap">
                    <div class="widget_top">
                        ...
                        <h6>
                            <asp:Label ID="lblHeader" runat="server" Text="Deleted Restoced Items" meta:resourcekey="lblHeaderResource1"></asp:Label></h6>
                    </div>
                    <div>
