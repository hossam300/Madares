<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/InventoryMasterPage.Master" AutoEventWireup="true" CodeBehind="AddProductCategory.aspx.cs" Inherits="ERPWebForms.Inventory.AddProductCategory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_6 alpha">
                                                <asp:TextBox ID="txtProductCategory" placeholder="Product Category" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtProductCategoryResource1"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtProductCategory" ErrorMessage="*" ForeColor="Red" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>
                                            </div>
                                    ...
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <div class="form_grid_10 alpha">
                                                <asp:TextBox TextMode="MultiLine" ID="txtCategoryDescription" placeholder="Description" Columns="5" Rows="5" runat="server" type="text" TabIndex="1" class="limiter required" meta:resourcekey="txtCategoryDescriptionResource1"></asp:TextBox>
                                            </div>
                                            <span class="clear"></span>
                                        </div>
                                    </div>
