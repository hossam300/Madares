                            ...
                            <fieldset title="<%$ Resources:Label7Resource1.Text %>" runat="server">
                                ...
                                <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" Width="100%" EnableTheming="True" Theme="Moderno" AutoGenerateColumns="False" DataMember="ID" KeyFieldName="ID" PreviewFieldName="ID" OnRowDeleting="grid_RowDeleting"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="StationID" VisibleIndex="2" Caption="Station" UnboundType="Integer" Width="100px" meta:resourcekey="GridViewDataComboBoxColumnResource2" >
                                            <PropertiesComboBox DataSourceID="SqlDataSource1" TextField="Name" ValueField="StationID">
                                            </PropertiesComboBox>
                                        </dx:GridViewDataComboBoxColumn>
                                        <dx:GridViewDataTextColumn FieldName="Amount" VisibleIndex="3" Caption="Amount" UnboundType="Decimal" Width="250px" meta:resourcekey="GridViewDataTextColumnResource2" >
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataComboBoxColumn FieldName="PaymentType" VisibleIndex="4" Caption="Payment Type" UnboundType="String" Width="150px" meta:resourcekey="GridViewDataComboBoxColumnResource3">
                                           <PropertiesComboBox DataSourceID="SqlDataSource2" TextField="PaymentType" ValueField="PaymentType">
                                            </PropertiesComboBox>
                                        </dx:GridViewDataComboBoxColumn>
