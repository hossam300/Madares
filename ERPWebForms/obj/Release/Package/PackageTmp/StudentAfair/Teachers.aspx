<%@ Page Title="" Language="C#" MasterPageFile="~/StudentAfair/SFMasterPage.master" AutoEventWireup="true" CodeBehind="Teachers.aspx.cs" Inherits="ERPWebForms.StudentAfair.Teachers" %>
            ...
            <div class="grid_12 full_block">
                <div class="widget_wrap">
                    <div class="widget_top">
                        ...
                        <h6>
                            <asp:Label ID="Label3" runat="server" Text="Teachers" meta:resourcekey="Label3Resource1"></asp:Label></h6>
                    </div>
                    <div>
                        <dx:ASPxButton ID="btnNewTeacher" runat="server" Text="Create New Teacher" Theme="PlasticBlue" OnClick="btnNewTeacher_Click" meta:resourcekey="btnNewTeacherResource1"></dx:ASPxButton>
                    ...
                    <div>
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" Width="100%" EnableTheming="True" Theme="Moderno" KeyFieldName="ID" PreviewFieldName="ID" EnableCallBacks="False" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" OnStartRowEditing="ASPxGridView1_StartRowEditing" meta:resourcekey="ASPxGridView1Resource1">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="Name" Caption="Name" VisibleIndex="1" Width="100px" meta:resourcekey="GridViewDataTextColumnResource2"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Phone" Caption="Phone" VisibleIndex="2" Width="100px" meta:resourcekey="GridViewDataTextColumnResource3"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="address" Caption="Address" VisibleIndex="5" Width="200px" meta:resourcekey="GridViewDataTextColumnResource4"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Email" Caption="Email" VisibleIndex="6" Width="100px" meta:resourcekey="GridViewDataTextColumnResource5"></dx:GridViewDataTextColumn>
