<%@ Page Title="" Language="C#" MasterPageFile="~/StudentAfair/SFMasterPage.Master" AutoEventWireup="true" CodeBehind="AddSupervisor.aspx.cs" Inherits="ERPWebForms.StudentAfair.AddSupervisor" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <div class="grid_12">
                <div class="widget_wrap">
                    <div class="widget_top">
                        ...
                        <h6>
                            <asp:Label ID="Label3" runat="server" Text="Create Supervisor" meta:resourcekey="Label3Resource1" ></asp:Label></h6>
                    </div>
