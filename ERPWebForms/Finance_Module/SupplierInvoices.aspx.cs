...
{
    public partial class SupplierInvoices : BasePage
    {
        ...
        {
            Response.Redirect("~/Finance_Module/AddSupplierInvoice.aspx?id=0");
        }
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnview")
            {
                ...
                Response.Redirect("~/Finance_Module/ViewSupplierInvoice.aspx?ID=" + id);
            }
        }
