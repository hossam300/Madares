...
namespace ERPWebForms.Finance_Module
{
    public partial class FinancialYears : BasePage
    {
        ...
        {
            Response.Redirect("~/Finance_Module/CreateFinancialYear.aspx?id=0");
        }
        protected void ASPxGridView1_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            int id = Convert.ToInt32(e.EditingKeyValue.ToString());
            Response.Redirect("~/Finance_Module/CreateFinancialYear.aspx?id=" + id.ToString());
        }
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            ...
            if (e.ButtonID == "btnview")
            {
                ...
                Response.Redirect("~/Finance_Module/ViewFinancialYear.aspx?id=" + id);
            ...
            if (e.ButtonID == "btnClose")
            {
                ...
                DataRow dr = ASPxGridView1.GetDataRow(Gid);
                int id = Convert.ToInt32(dr["id"].ToString());
                Response.Redirect("~/Finance_Module/CloseFinancialYear.aspx?id=" + id);
