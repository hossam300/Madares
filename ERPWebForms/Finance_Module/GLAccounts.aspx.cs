...
{
    public partial class GLAccounts : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!new UserSecurity().CheckFormPermission((int)Global.formSecurity.GLAccounts, Request.Cookies["user"]["Permission"].ToString()))
                    Response.Redirect("~/Finance_Module/UnAuthorized.aspx");
            }
            GLAccount glaccount = new GLAccount();
            DataTable dt = glaccount.getList(0);
        ...
        {
            Response.Redirect("~/Finance_Module/CreateNewGLAccount.aspx?id=0&parent=0&acctType=1");
        }
